...
map({ "i" }, "	", utils.SmartTabOnEmptyLine, { noremap = true, expr = true, desc = "Auto indent" })
map({ "i" }, "<Down>", utils.SmartTabOnEmptyLine2, { noremap = true, expr = true, desc = "Auto indent" })
map({ "i" }, "<Up>", utils.SmartTabOnEmptyLine3, { noremap = true, expr = true, desc = "Auto indent" })
