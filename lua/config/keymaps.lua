...
map({ "n", "v" }, "<leader>p", "oq<BS><Esc>P", { noremap = true, silent = true, desc = "Paste in new line" })
...
map({ "n", "v" }, "<leader>bf", ":bnext<CR>", { silent = true, desc = "Next buffer" })
map({ "n", "v" }, "<leader>bb", ":bprevious<CR>", { silent = true, desc = "Previous buffer" })
vim.keymap.set("n", "<F13>", ":bnext<CR>", { silent = true })
